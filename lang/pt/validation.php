...
return [
    ...
    'gte' => [
        ...
        'file' => 'O campo :attribute deve conter um arquivo maior ou igual a :value kilobytes.',
    ...
    'lte' => [
        ...
        'file' => 'O campo :attribute deve conter um arquivo menor ou igual a :value kilobytes.',
        'string' => 'O campo :attribute deve conter :value caracteres ou menos.',
        'array' => 'O campo :attribute deve conter :value itens ou menos.',
    ],
    'max' => [
        'numeric' => 'O campo :attribute não pode conter um número superior a :max.',
    ...
    'min' => [
        'numeric' => 'O campo :attribute deve conter um número no mínimo :min.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Traduções customizadas de validação
    |--------------------------------------------------------------------------
    */
